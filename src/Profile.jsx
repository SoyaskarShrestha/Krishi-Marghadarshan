...
import './Profile.css'
import guideImage from './assets/weather/guide.jpg'
...
function BadgeIcon() {
	return (
		<svg viewBox="0 0 24 24" aria-hidden="true" className="advisory-icon-svg">
			<path
				d="m12 3 2.2 1.2 2.5-.2.9 2.3 2 1.5-.8 2.4.8 2.4-2 1.5-.9 2.3-2.5-.2L12 21l-2.2-1.2-2.5.2-.9-2.3-2-1.5.8-2.4-.8-2.4 2-1.5.9-2.3 2.5.2L12 3Zm-1.4 9.2 1.3 1.3 2.7-2.7"
				fill="none"
				stroke="currentColor"
				strokeWidth="1.7"
				strokeLinecap="round"
	...
	return (
		<div className="advisory-page">
			<header className="advisory-header">
				<div className="advisory-shell advisory-header-inner">
					<h1 className="advisory-brand">Krishi Margadarshan</h1>

					<nav className="advisory-nav" aria-label="Main navigation">
					...
					<div className="advisory-language">
						<span className="advisory-language-icon"><LanguageIcon /></span>
						<span>Language</span>
					</div>
				</div>
			</header>
			...
			<main className="advisory-shell advisory-main">
				<section className="advisory-hero">
					<div className="advisory-hero-copy">
						...
						<p>
							तपाईँको खेतीपाती सम्बन्धी जिज्ञासाहरू हाम्रा विज्ञहरूलाई सोध्नुहोस् र उचित समाधान
							परामर्श गर्नुहोस् । हामी तपाईँको समृद्धिको साथी हो ।
						</p>
					</div>

					<div className="advisory-hero-image-wrap">
						<img src={guideImage} alt="Farmer standing in a field holding vegetables" className="advisory-hero-image" />
						<div className="advisory-floating-card">
							<span className="advisory-floating-icon"><BadgeIcon /></span>
							<div>
				...
				<section className="advisory-ask-section">
					<div className="advisory-ask-copy">
						...
						<p>
							हाम्रो टोलीमा बाली वैज्ञानिक, माटो विज्ञ र भेटेरिनरी डाक्टरहरू समावेश छन् । तपाईँको
							प्रश्न पठाउनुहोस्, हामी ३ कार्यदिनभित्र जवाफ दिनेछौं ।
						</p>
