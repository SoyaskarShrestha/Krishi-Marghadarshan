					...
					<form className="advisory-form-card">
						...
						<label>
							...
							<div className="advisory-select-wrap">
								<select defaultValue={content.categoryDefault}>
									<option>{content.categoryDefault}</option>
									<option>{isNepali ? 'माटो परीक्षण' : 'Soil Testing'}</option>
									<option>{isNepali ? 'पशुपालन' : 'Livestock'}</option>
								</select>
						...
						<label>
							...
							<textarea rows="5" placeholder={content.questionPlaceholder} />
						</label>
